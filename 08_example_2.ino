...
float USS_measure(int TRIG, int ECHO)
{
  ...
  if(reading < dist_min || reading > dist_max) reading = last_reading; // return raw when out of range.
  else last_reading = reading;
  return reading;
